...
export class Video extends VideoBase {
    constructor() {
        ...
        this._setupMediaPlayerListeners = function () {
    ...
    _openVideo() {
        ...
        try {
           ...
           // var bm = new com.google.android.exoplayer2.upstream.DefaultHttpDataSource.Factory();
            //var baseFac = new com.google.android.exoplayer2.upstream.HttpDataSource.BaseFactory();
            //com.google.android.exoplayer2.upstream.HttpDataSource.BaseFactory.setDefaultRequestProperties(headers);
           // com.google.android.exoplayer2.upstream.DefaultHttpDataSource.Factory
            //httpDataSource.setDefaultRequestProperties​(headers);
            var httpDataSource = new com.google.android.exoplayer2.upstream.DefaultHttpDataSource.Factory();//   .createDataSource();
            httpDataSource.setDefaultRequestProperties(headers);
           // bm.setDefaultRequestProperties​(headers);
            ...
            var dsf = new com.google.android.exoplayer2.upstream.DefaultDataSourceFactory(this._context, /*com.google.android.exoplayer2.util.Util.getUserAgent(this._context, Utils.ad.getApplicationContext().getPackageName()),*/ bm, httpDataSource);
